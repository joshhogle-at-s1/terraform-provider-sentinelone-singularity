...
Errors are logged for the diagnostic errors output during `terraform` calls but are also logged using `tflog` calls in order to make them stand out more easily and allow for additional field data.
